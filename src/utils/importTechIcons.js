...
import spring from '../assets/icons/spring-icon.png';
...
const techIcons = {
    'angular-icon.png': angular,
    'css-icon.png': css,
    'docker-icon.png': docker,
    'git-icon.png': git,
    'github-icon.png': github,
    'html-icon.png': html,
...
const techUrls = {
    'angular-icon.png': 'https://angular.io/',
    'css-icon.png': 'https://developer.mozilla.org/en-US/docs/Web/CSS',
    'docker-icon.png': 'https://www.docker.com/',
    'git-icon.png': 'https://git-scm.com/',
